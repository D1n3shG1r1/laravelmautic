...
const Layout = ({ pageTitle, children }) => {
    ...
    const handleSidebarToggle = () => {
        setIsSidebarActive(prevState => !prevState);  // Toggle sidebar active state
    };

    // State to track the collapse status for multiple dropdowns
    const [collapsedState, setCollapsedState] = useState({});

    // Handle toggle for specific dropdowns
    const handleToggle = (dropdownId) => {
        setCollapsedState(prevState => ({
            ...prevState,
            [dropdownId]: !prevState[dropdownId]  // Toggle the specific dropdown
        }));
    };
        ...
        <>
            ...
            <div className="full_container">
                <div className="inner_container">
                    {/* Sidebar */}
                    <nav id="sidebar" className={`ps ps--active-y ${isSidebarActive ? 'active' : ''}`}>
                            ...
                            <div className="sidebar_user_info">
                                ...
                                <div className="user_profle_side">
                                    <div className="user_img">
                                        <img className="profilephotoimg img-responsive" src={userPng} />
                                    </div>
                        ...
                        <div className="sidebar_blog_2">
                            ...
                            <ul className="list-unstyled components">
                                ...
                                <li>
                                    <a
                                        onClick={() => handleToggle('channels')}  // Pass dropdownId as 'channels'
                                        className="dropdown-toggle"
                                        aria-expanded={collapsedState['channels'] ? 'true' : 'false'}
                                    >
                                            ...
                                            <ul className="user_profile_dd">
                                                <li>
                                                    <a 
                                                        ...
                                                        onClick={() => handleToggle('userProfile')}  // Use a different id for user profile
                                                        aria-expanded={collapsedState['userProfile'] ? 'true' : 'false'}
                                                    >
                                                        <img className="profilephotoimg img-responsive rounded-circle" src={userPng2} alt="#" />
