                        ...
                        <div className="right_topbar">
                            <div className="icon_info">
                                ...
                                <ul className="user_profile_dd">
                                    ...
                                    ><img className="profilephotoimg img-responsive rounded-circle" src={userPng2} alt="#" /><span className="name_user">{userFullName}</span></a>
                        
                                    <div className={`dropdown-menu ${isCollapsed ? '' : 'show'}`}>
