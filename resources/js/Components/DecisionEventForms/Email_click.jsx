  ...
  return (
    ...
    <div className="bundle-form">
      <div className="bundle-form-header mb-10">
        <h3>Clicks email</h3>
        <h6 className="text-muted">Trigger actions when an email is clicked. Connect a Send Email action to the top of this decision.</h6>
      </div>
        ...
        <div className="row">
            ...
            <div id="campaignevent_properties">
                <div className="row">
                    <div className="form-group col-xs-12 ">
                          <InputLabel className="control-label hide" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title="">Limit to Urls contains <i className="ri-question-line"></i></InputLabel>
                        
                          <TextInput type="hidden" id="campaignevent_properties_urls_list_0" name="campaignevent[properties][urls][list][0]" autoComplete="false" className='form-control'/>
                    </div>
                </div>
            </div>
        </div>
