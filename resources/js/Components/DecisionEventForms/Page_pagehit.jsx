  ...
  return (
    ...
    <div className="bundle-form">
      <div className="bundle-form-header mb-10">
        <h3>Visits a page</h3>
        <h6 className="text-muted">Trigger actions on a page/url hit.</h6>
      </div>
        ...
        <div className="row">
          <div className="form-group col-xs-12">
            <div id="campaignevent_properties">
                ...
                <div className="row">
                    <div className="form-group col-xs-12">
                        <label className="control-label" htmlFor="campaignevent_properties_pages" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title="Select the pages this trigger applies to. If none are selected, it'll apply to any page.">
                            Limit to Pages <i className="ri-question-line"></i>
                        </label>
                            
                        <div className="choice-wrapper">      
                            <select id="campaignevent_properties_pages" name="campaignevent[properties][pages][]" className="form-control" autoComplete="false" multiple="multiple"></select>
                        </div>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="form-group col-xs-12">
                        <label className="control-label" htmlFor="campaignevent_properties_url" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title="Insert the URL of the page where you placed the tracking pixel. It is possible to use wildcard (*). Example: *product/123* will match http://web.com/product/1234.htm. Separate multiple URLs with a comma.">
                        URL <i className="ri-question-line"></i></label>
                        <input type="text" id="campaignevent_properties_url" name="campaignevent[properties][url]" className="form-control" autoComplete="false" />
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="form-group col-xs-12">
                        <label className="control-label" htmlFor="campaignevent_properties_referer" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title="Insert the Referrer URL of the page where you placed the tracking pixel. It is possible to use wildcard (*). Example: *product/123* will match http://web.com/product/1234.htm. Multiple Referrer URLs separate with comma.">
                        Referrer <i className="ri-question-line"></i></label>
                        <input type="text" id="campaignevent_properties_referer" name="campaignevent[properties][referer]" className="form-control" autoComplete="false"/>
                    </div>
                </div>
