  ...
  return (
    ...
    <div className="bundle-form">
      <div className="bundle-form-header mb-10">
        <h3>Submits form</h3>
        <h6 className="text-muted">Trigger actions when a contact submits a form</h6>
      </div>
        ...
        <div class="row">
            ...
            <div id="campaignevent_properties">
                <div class="row">
                    <div class="form-group col-xs-12 ">
                        <label class="control-label" for="campaignevent_properties_assets" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title="Select the form(s) that will trigger the actions for dripflow.">
                        Limit to Forms <i class="ri-question-line"></i></label>
                        <div class="choice-wrapper">
                        <select id="campaignevent_properties_forms" name="campaignevent[properties][forms][]" class="form-control" autoComplete="false" >
