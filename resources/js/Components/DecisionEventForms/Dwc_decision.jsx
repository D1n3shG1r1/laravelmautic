...
const DecisionModalContent = ({inputData, jsPlumbInstanceRef}) => {
  ...
  const saveEvent = (event) =>{
      ...
      var dwcontents = document.getElementById("campaignevent_properties_dwcontents").value;
      ...
      if(!isRealVal(eventName)){
          ...
          return false;
      }else if(!isRealVal(dwcontents)){
          var err = 1;
          var msg = "Content is required.";
          showToastMsg(err, msg);
          return false;
      }else{
        //campaignevent_form
  ...
  return (
    ...
    <div className="bundle-form">
      <div className="bundle-form-header mb-10">
        <h3>Request dynamic content</h3>
        <h6 className="text-muted">This is the top level for a dynamic content request.</h6>
      </div>
        ...
        <div class="row">
            ...
            <div id="campaignevent_properties">
                <div class="row">
                    <div class="form-group col-xs-12 ">
                        <label class="control-label" for="campaignevent_properties_assets" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title="Select the default dynamic content to show.">
                        Select Default Content <i class="ri-question-line"></i></label>
                        <div class="choice-wrapper">
                        <select id="campaignevent_properties_dwcontents" name="campaignevent[properties][dynamiccontent][]" class="form-control" autoComplete="false" >
