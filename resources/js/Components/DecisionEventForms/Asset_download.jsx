...
const DecisionModalContent = ({inputData, jsPlumbInstanceRef}) => {
  ...
  useEffect(() => {
    if (window.jQuery) {
      ...
      $('#campaignevent_properties_assets').select2({
      ...
      return () => {
        $('#campaignevent_properties_assets').select2('destroy');
      };
  ...
  const saveEvent = (event) =>{
      ...
      var assets = document.getElementById("campaignevent_properties_assets").value;
      ...
      if(!isRealVal(eventName)){
          ...
          return false;
      }else if(!isRealVal(assets)){
          var err = 1;
          var msg = "Assets are required.";
          showToastMsg(err, msg);
          return false;
      }else{
        //campaignevent_form
  ...
  return (
    ...
    <div className="bundle-form">
      <div className="bundle-form-header mb-10">
        <h3>Downloads asset</h3>
        <h6 className="text-muted">Trigger actions upon downloading an asset.</h6>
      </div>
        ...
        <div class="row">
            ...
            <div id="campaignevent_properties">
                <div class="row">
                    <div class="form-group col-xs-12 ">
                        <label class="control-label" for="campaignevent_properties_assets" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title="Select the assets this trigger applies to. If none are selected, the event will trigger for any asset.">
                        Limit to Assets <i class="ri-question-line"></i></label>
                        <div class="choice-wrapper">
                        <select id="campaignevent_properties_assets" name="campaignevent[properties][assets][]" class="form-control" autoComplete="false" multiple="multiple">
