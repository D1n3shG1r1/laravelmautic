...
const GrapesJSBuilder = ({ containerId, apiUrl }) => {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh' }}>
      <div id={containerId} style={{ flex: 1, border: '1px solid #ccc' }}></div>
      <div id="blocks" style={{ width: '300px', background: '#2b2b2b', padding: '10px' }}></div>
    </div>
  );
};
