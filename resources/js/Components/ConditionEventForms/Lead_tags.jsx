...
const DecisionModalContent = ({inputData, jsPlumbInstanceRef}) => {
  ...
  useEffect(() => {
    if (window.jQuery) {
      ...
      $('#campaignevent_properties_tags').select2({
      ...
      return () => {
        $('#campaignevent_properties_tags').select2('destroy');
      };
  ...
  const saveEvent = (event) =>{
      ...
      var tags = document.getElementById("campaignevent_properties_tags").value;
  ...
  return (
    ...
    <div className="bundle-form">
      <div className="bundle-form-header mb-10">
        <h3>Contact tags</h3>
        <h6 className="text-muted">Condition based on a contact tags.</h6>
      </div>
        ...
        <div className="row">
            ...
            <div id="campaignevent_properties">
                <div className="row">
                    <div className="form-group col-xs-12 ">
                        <InputLabel className="control-label required" for="campaignevent_properties_tags">Tags
                        <i className="ri-question-line"></i></InputLabel>
                        
                        <div className="choice-wrapper">
                            <select id="campaignevent_properties_tags" name="campaignevent[properties][tags][]" className="form-control" autoComplete="false" multiple="multiple">
