...
const DecisionModalContent = ({inputData, jsPlumbInstanceRef}) => {
  ...
  useEffect(() => {
    if (window.jQuery) {
      ...
      $('#campaignevent_properties_segments').select2({
      ...
      return () => {
        $('#campaignevent_properties_segments').select2('destroy');
      };
  ...
  const saveEvent = (event) =>{
      ...
      var segments = document.getElementById("campaignevent_properties_segments").value;
  ...
  return (
    ...
    <div className="bundle-form">
      <div className="bundle-form-header mb-10">
        <h3>Contact segments</h3>
        <h6 className="text-muted">Condition based on a contact segments.</h6>
      </div>
        ...
        <div className="row">
          <div className="form-group col-xs-12">
            <InputLabel className="control-label" htmlFor="campaignevent_name" value=
            "Name" />
            <TextInput
              type="text"
        ...
        <div className="row">
            ...
            <div id="campaignevent_properties">
                <div className="row">
                    <div className="form-group col-xs-12 ">
                        <InputLabel className="control-label required" for="campaignevent_properties_segments">Segments
                        <i className="ri-question-line"></i></InputLabel>
                        
                        <div className="choice-wrapper">
                            <select id="campaignevent_properties_segments" name="campaignevent[properties][segments][]" className="form-control" autoComplete="false" multiple="multiple">
                            
                            {segmentsOptions.map((segment) => (
                              <option
                              key={`seg_${segment.id}`}
                              id={`eventSegment_${segment.id}`}
                              title={`${segment.name}`}
                              value={segment.id}>
                                  {`${segment.name}`}
                              </option>
