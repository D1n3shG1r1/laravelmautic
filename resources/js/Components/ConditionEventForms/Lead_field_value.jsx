...
const DecisionModalContent = ({inputData, jsPlumbInstanceRef}) => {
  ...
  useEffect(() => {
    if (window.jQuery) {
      ...
      $('#campaignevent_properties_field').select2({
        placeholder: "Select Field",
        allowClear: true,
        width: '100%', // Makes it responsive
      });

      $('#campaignevent_properties_operator').select2({
      ...
      return () => {
        $('#campaignevent_properties_field').select2('destroy');
        $('#campaignevent_properties_operator').select2('destroy');
      };
...
const createNode = (propJson, x, y) => {
  ...
  const saveEvent = (event) =>{
      ...
      var field = document.getElementById("campaignevent_properties_field").value;
      var operator = document.getElementById("campaignevent_properties_operator").value;
  ...
  return (
    ...
    <div className="bundle-form">
      <div className="bundle-form-header mb-10">
        <h3>Contact field value</h3>
        <h6 className="text-muted">Condition based on a contact field value.</h6>
      </div>
        ...
        <div className="row">
            ...
            <div id="campaignevent_properties">
                <div className="row">
                    <div className="form-group col-xs-12 ">
                        <InputLabel className="control-label required" htmlFor="campaignevent_properties_field" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title="Select the contact field which holds the value you want to compare.">Contact Field <i className="ri-question-line"></i></InputLabel>
                        
                        <div className="choice-wrapper">
                            <select id="campaignevent_properties_field" name="campaignevent[properties][field][]" className="form-control" autoComplete="false">
                ...
                <div className="row">
                    <div className="form-group col-xs-12 ">
                        <InputLabel className="control-label required" htmlFor="campaignevent_properties_operator" value="Operator" />
                        
                        <div className="choice-wrapper">
                        <select id="campaignevent_properties_operator" name="campaignevent[properties][operator]">
                            ...
                            <option value="!like">not like</option>
                            <option value="regexp">regexp</option>
                            <option value="!regexp">not regexp</option>
                ...
                <div className="row">
                    <div className="form-group col-xs-12 ">
                        <InputLabel className="control-label required" htmlFor="campaignevent_properties_value" value="Value"/>
                        
                        <TextInput type="text" className="form-control" id="campaignevent_properties_value" name="campaignevent[properties][value]" autoComplete="false" />
                    </div>
                </div>
