  ...
  return (
    ...
    <div className="bundle-form">
      <div className="bundle-form-header mb-10">
        <h3>Remove Do Not Contact</h3>
        <h6 className="text-muted">Remove Do Not Contact flag from contact</h6>
      </div>
        ...
        <div className="row">
            ...
            <div id="campaignevent_properties">
                <div className="row">
                    <div className="form-group col-xs-12 ">
                        <label class="control-label required" for="campaignevent_properties_channels">
                        Channels<i class="ri-question-line"></i>
                        </label>
                        
                        <div class="choice-wrapper">
                            <select id="campaignevent_properties_channels" name="campaignevent[properties][channels][]" className="form-control" autoComplete="false" multiple="multiple">
