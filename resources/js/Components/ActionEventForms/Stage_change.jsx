  ...
  return (
    ...
    <div className="bundle-form">
      <div className="bundle-form-header mb-10">
        <h3>Change contact's stage</h3>
        <h6 className="text-muted">Choose a stage to change a contact to.</h6>
      </div>
        ...
        <div className="row">
            ...
            <div id="campaignevent_properties">
                <div className="row">
                    <div className="form-group col-xs-12 ">
                        <label class="control-label required" for="campaignevent_properties_stage" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title="Select stage that will be assigned to contacts in this campaign">
                        Select stage <i class="ri-question-line"></i>
                        </label>
                        
                        <div class="choice-wrapper">
                            <select id="campaignevent_properties_stage" name="campaignevent[properties][stage][]" className="form-control" autoComplete="false" multiple="multiple">
