  ...
  return (
    ...
    <div className="bundle-form">
      <div className="bundle-form-header mb-10">
        ...
        <h6 className="text-muted">Update the current contact's fields with the defined values from this action.</h6>
      </div>
        ...
        <div className="row">
          <div className="form-group col-xs-12">
            <InputLabel className="control-label" htmlFor="campaignevent_name" value="Name"/>
                ...
                <div id="campaignevent_properties">
                    <div className="row">
                        <div class="form-group col-xs-12">
                            <InputLabel className="control-label" htmlFor="campaignevent_properties_title" value="Title" />
                            <TextInput type="text"
                            id="campaignevent_properties_title"
                            name="campaignevent[properties][title]" className="form-control"
                            autoComplete="false"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-xs-12">
                            <InputLabel className="control-label" htmlFor="campaignevent_properties_firstname" value="First Name" />
                            <TextInput type="text" id="campaignevent_properties_firstname" name="campaignevent[properties][firstname]"
                            className="form-control"
                            autoComplete="false"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-xs-12">
                            <InputLabel className="control-label" htmlFor="campaignevent_properties_lastname" value="Last Name" />
                            <TextInput type="text" id="campaignevent_properties_lastname"
                            name="campaignevent[properties][lastname]"
                            className="form-control"
                            autoComplete="false"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-xs-12">
                            <InputLabel className="control-label" htmlFor="campaignevent_properties_email" value="Email"/>
                            <TextInput type="email" id="campaignevent_properties_email"
                            name="campaignevent[properties][email]"
                            className="form-control"
                            autoComplete="false"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-xs-12">
                            <InputLabel className="control-label" htmlFor="campaignevent_properties_mobile" value="Mobile"/>
                            <TextInput type="text" id="campaignevent_properties_mobile"
                            name="campaignevent[properties][mobile]"
                            className="form-control"
                            autoComplete="false"/>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div class="form-group col-xs-12">
                            <InputLabel className="control-label" htmlFor="campaignevent_properties_address1" value="Address Line 1" />
                            <TextInput type="text" id="campaignevent_properties_address1"
                            name="campaignevent[properties][address1]"
                            className="form-control"
                            autoComplete="false"/>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="form-group col-xs-12">
                            <InputLabel className="control-label" htmlFor="campaignevent_properties_address2" value="Address Line 2" />
                            <TextInput type="text" id="campaignevent_properties_address2"
                            name="campaignevent[properties][address2]"
                            className="form-control"
                            autoComplete="false"/>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="form-group col-xs-12">
                            <InputLabel className="control-label" htmlFor="campaignevent_properties_city" value="City" />
                            <TextInput type="text"
                            id="campaignevent_properties_city"
                            name="campaignevent[properties][city]"
                            className="form-control"
                            autoComplete="false"/>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="form-group col-xs-12">
                            <InputLabel className="control-label" htmlFor="campaignevent_properties_state" value="State" />
                            <TextInput type="text"
                            id="campaignevent_properties_state"
                            name="campaignevent[properties][state]"
                            className="form-control"
                            autoComplete="false"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-xs-12">
                            <InputLabel className="control-label" htmlFor="campaignevent_properties_zip" value="Zip Code"/>
                            <TextInput type="text"
                            id="campaignevent_properties_zip"
                            name="campaignevent[properties][zip]"
                            className="form-control"
                            autoComplete="false"/>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="form-group col-xs-12">
                            <InputLabel className="control-label" htmlFor="campaignevent_properties_country" value="Country" />
                            <TextInput type="text" id="campaignevent_properties_country"
                            name="campaignevent[properties][country]"
                            className="form-control"
                            autoComplete="false"/>
                        </div>
                    </div>
        ...
        <div className="modal-footer">
            <div className="modal-form-buttons">
              <SecondaryButton type="submit" isLoading={isLoading} className="btn btn-outline-secondary btn-default btn-save btn-copy"> <i className="ri-add-line"></i> Add </SecondaryButton>

              <SecondaryButton type="button" className="btn btn-outline-secondary btn-default btn-cancel btn-copy" onClick={() => cancelEvent()} data-bs-dismiss="modal"><i className="ri-close-line"></i> Cancel</SecondaryButton>
            </div>
        </div>
        </form>
        </>
