...
const DecisionModalContent = ({inputData, jsPlumbInstanceRef}) => {
  ...
  */
  ...
  const saveEvent = (event) =>{
      ...
      var points = document.getElementById("campaignevent_properties_points").value;
  ...
  return (
    ...
    <div className="bundle-form">
      <div className="bundle-form-header mb-10">
        <h3>Adjust contact points</h3>
        <h6 className="text-muted">Increase or decrease points</h6>
      </div>
        ...
        <div className="row">
            ...
            <div id="campaignevent_properties">
                <div className="row">
                    <div className="form-group col-xs-12 ">
                        <label className="control-label required" for="campaignevent_properties_points">
                        Points (+/-)</label>
                        <input type="text" id="campaignevent_properties_points" name="campaignevent[properties][points][]" className="form-control" autoComplete="false" defaultValue={0}/>
                    </div>
                </div>
            </div>
        </div>
