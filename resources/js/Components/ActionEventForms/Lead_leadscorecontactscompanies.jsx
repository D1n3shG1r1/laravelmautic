...
const DecisionModalContent = ({inputData, jsPlumbInstanceRef}) => {
  ...
  const saveEvent = (event) =>{
      ...
      var score = document.getElementById("campaignevent_properties_score").value;
      ...
      if(!isRealVal(eventName)){
          ...
          return false;
      }else if(!isRealVal(score)){
          var err = 1;
          var msg = "Score is required.";
          showToastMsg(err, msg);
          return false;
      }else{
        //campaignevent_form
  ...
  return (
    ...
    <div className="bundle-form">
      <div className="bundle-form-header mb-10">
        <h3>Add to company's score</h3>
        <h6 className="text-muted">This action will add the specified value to the company's existing score</h6>
      </div>
        ...
        <div class="row">
            ...
            <div id="campaignevent_properties">
                <div class="row">
                    <div class="form-group col-xs-12 ">
                        <label class="control-label required" for="campaignevent_properties_score">
                        Add to company's score</label>
                        <input type="text" id="campaignevent_properties_score" name="campaignevent[properties][score][]" className="form-control" autoComplete="false" defaultValue={0} />
