...
const DecisionModalContent = ({inputData, jsPlumbInstanceRef}) => {
  ...
  useEffect(() => {
    if (window.jQuery) {
      ...
      $('#campaignevent_properties_company').select2({
      ...
      return () => {
        $('#campaignevent_properties_company').select2('destroy');
      };
  ...
  const saveEvent = (event) =>{
      ...
      var company = document.getElementById("campaignevent_properties_company").value;
  ...
  return (
    ...
    <div className="bundle-form">
      <div className="bundle-form-header mb-10">
        <h3>Add to company action</h3>
        <h6 className="text-muted">This action will add contacts to the selected company</h6>
      </div>
        ...
        <div class="row">
            ...
            <div id="campaignevent_properties">
                <div class="row">
                    <div class="form-group col-xs-12 ">
                        <label class="control-label required" for="campaignevent_properties_company">
                        Companies</label>

                        <select id="campaignevent_properties_company" name="campaignevent[properties][company][]" className="form-control form-select" autoComplete="false">
