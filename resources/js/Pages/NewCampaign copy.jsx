...
/*
import "customcss/libraries.css";
...
const newcampaign = ({pageTitle,csrfToken,params}) => {
  ...
  const closeEventListModal = (targetElmId, targetElmParentId) =>{
    ...
    <Layout pageTitle={pageTitle}>
        ...
        <div id="campaign-builder" className={`${Styles.campaignBuilder} builder campaign-builder live builder-active-dk`}>
        
        <div className={`${Styles.btnsBuilder} btns-builder-dk`}>
        ...
        <div id="builder-errors" className={`${Styles.builderErrors} alert alert-danger`} role="alert" style={{ display: 'none' }}>test</div>

        <div id="CampaignEventPanel" className={`${Styles.CampaignEventPanel} hide`}>
          <div id="CampaignEventPanelGroups" className={`${Styles.CampaignEventPanelGroups} groups-enabled-3 hide`}>
            <div className="row">
              <div className="mr-0 ml-0 pl-xs pr-xs campaign-group-container col-md-4" id="DecisionGroupSelector">
                <div className={`${Styles.panel} ${Styles.panelSuccess} mb-0`}>
                  <div className={`${Styles.panelHeading}`}>
                    ...
                    <div className="col-xs-4 col-sm-2 pl-0 pr-0 pt-10 pb-10 text-right">
                      ...
                      <button className={`decisionSlctBtn visible-xs pull-right btn btn-sm btn-default btn-nospin ${Styles.textSuccess}`} data-type="Decision" onClick={(e) => selectEvent(e, 'decision')}>Select</button>
                    </div>
                  </div>
                  ...
                  <div className={`${Styles.textCenter} ${Styles.panelFooter} hidden-xs`}>
                    <button className={`decisionSlctBtn btn btn-lg btn-default btn-nospin ${Styles.textSuccess}`} data-type="Decision" onClick={(e) => selectEvent(e, 'decision')}>Select</button>
                  </div>
                </div>
              </div>
              <div className="mr-0 ml-0 pl-xs pr-xs campaign-group-container col-md-4" id="ActionGroupSelector">
                <div className={`${Styles.panel} ${Styles.panelPrimary} mb-0`}>
                  <div className={`${Styles.panelHeading}`}>
                    <div className="col-xs-8 col-sm-10 np">
                  ...
                  <div className={`hidden-xs ${Styles.panelFooter} ${Styles.textCenter}`}>
              ...
              <div className="mr-0 ml-0 pl-xs pr-xs campaign-group-container col-md-4" id="ConditionGroupSelector">
                <div className={`${Styles.panel} panel-danger mb-0`}>
                  <div className={`${Styles.panelHeading}`}>
                    <div className="col-xs-8 col-sm-10 np">
            ...
            <div className="row">
              <div className="mr-0 ml-0 pl-xs pr-xs campaign-group-container col-md-12">
                <div id="CampaignPasteContainer" className={`${Styles.CampaignPasteContainer} ${Styles.panel} hide`}>
          ...
          <div id="CampaignEventPanelLists" className="hide">
            <div id="SourceGroupList" className={`${Styles.EventGroupList} eventList hide`}>
              <h4 className="mb-xs">
            ...
            <div id="ActionGroupList" className={`${Styles.EventGroupList} eventList hide`}>
              <h4 className="mb-xs">
                <span>Actions</span>
            ...
            <div id="DecisionGroupList" className={`${Styles.EventGroupList} eventList hide`}>
              <h4 className="mb-xs">
                <span>Decisions</span>
            ...
            <div id="ConditionGroupList" className={`${Styles.EventGroupList} eventList hide`}>
              <h4 className="mb-xs">
        ...
        <div className="builder-content" style={{ overflow: 'auto' }}>
          <div id="CampaignCanvas" className={`${Styles.CampaignCanvas}`}>
            <div id="CampaignEvent_newsource" className={`${Styles.textCenter} ${Styles.listCampaignSource} ${Styles.listCampaignLeadsource} list-campaign-leadsource`} style={{ left: '545px', top: '50px' }}>
              <div className={`${Styles.campaignEventContent}`}>
                <div>
                  <span className={`campaign-event-name ${Styles.ellipsis}`}>
