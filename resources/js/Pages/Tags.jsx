...
const Tags = ({ pageTitle, csrfToken, params }) => {
                        ...
                        <div className="col-md-12">
                            <div className="page_title row">
                                ...
                                <div className={`${Styles.textAlignRight} col-md-6`}>
                                    <NavLink className="btn cur-p btn-outline-primary" href="tags/new">
                                                ...
                                                {tags.length === 0 ? (
                                                    ...
                                                    tags.map(tag => (
                                                        <tr key={tag.id}>
                                                            ...
                                                            <td>
                                                                <LinkButton type="button" className={`btn p-0`} onClick={() => editTag(tag.id)} title="Edit">
                                                                    <i className={`${Styles.filterTrashIcon} fa fa-edit`}></i>
                                                                </LinkButton>

                                                                <span className={`${Styles.buttonSeprator}`}></span>

                                                                <LinkButton type="button" className={`btn p-0`} onClick={() => deleteTag(tag)} title="Delete">
