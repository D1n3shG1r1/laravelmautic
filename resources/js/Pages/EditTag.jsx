...
const newtag = ({pageTitle,csrfToken,params}) => {
    ...
    const save = (event) => {
        ...
        var formDataJson = $("#tagForm").serialize();
            ...
            <div className="container-fluid">
                ...
                <div className="row column1">
                    ...
                    <div className="col-md-9">
                        <form id="tagForm" className="white_shd full margin_bottom_30" ref={formRef} onSubmit={save} method="post">
                                                    ...
                                                    <div className="col-md-12 form-group mb-3">
                                                        ...
                                                        <div className="row mb-3">
                                                            <div className="col-md-12">
                                                                ...
                                                                <TextInput type="hidden" className="form-control" name="description" id="description" placeholder="Tag Description" value={formValues.description} onChange={handleInputChange} />
