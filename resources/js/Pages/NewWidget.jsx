...
const NewWidget = ({pageTitle,csrfToken,params}) => {
    ...
    const [formValues, setFormValues] = useState({
        ...
        widgetPurpose:'',
        widgetWebsite:'',
        widgetType:'webform', //default is webform [webform, popup, webhook]
        description:'',
        widgetHeading:'Join Our List'
    });
    ...
    const handleChange = (e) => {
        ...
        formValues.widgetType = e.target.value;
        */
    ...
    const Create = () => {
        ...
        if (!isRealVal(widgetName)) {
            ...
            return;
        } else if ((widgetType === 'popup' || widgetType === 'webhook') && !isRealVal(widgetWebsite)) {
            ...
            httpRequest(url, postJson, function(resp){
                ...
                if(C == 100 && error == 0){
                    ...
                    const widgetId = R.widgetId;
                    const codeSnippet = R.codeSnippet;
                    //generate widget code snippet
                    
                    document.getElementById("codeSnippet").innerText = codeSnippet;
                                                ...
                                                <div className="form-group roww mb-3">
                                                    ...
                                                    <div className='row mb-3'>
                                                        ...
                                                        <div className="col-md-6 text-end">
                                                            <PrimaryButton type="button" isLoading={isLoading} className="main_bt" onClick={Create}>Create</PrimaryButton>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className="full center_text">
                                                ...
                                                <p ref={paragraphRef} id="codeSnippet" className={`${Styles.codeSnippetText} form-control`}></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
